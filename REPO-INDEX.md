...
|---|---|---|---|
| `heritageai-ppha` | PPHA (Preliminary Planning and Heritage Appraisal) — free lead-magnet, £195 upsell path via funnel | `heritageai-ppha/docs/env-audit.md`, `ppha-overview.md`, `COMPLIANCE.md` | HAI — PPHA Builder |
